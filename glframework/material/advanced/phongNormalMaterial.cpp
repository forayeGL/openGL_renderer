...
const char* PhongNormalMaterial::getVertexShaderPath() const {
	return "assets/shaders/advanced/phongNormal.vert";
}

const char* PhongNormalMaterial::getFragmentShaderPath() const {
	return "assets/shaders/advanced/phongNormal.frag";
}

void PhongNormalMaterial::applyUniforms(
	Shader* shader,
	Mesh* mesh,
	Camera* camera,
