...
const char* PhongEnvMaterial::getVertexShaderPath() const {
	return "assets/shaders/phongEnv.vert";
}

const char* PhongEnvMaterial::getFragmentShaderPath() const {
	return "assets/shaders/phongEnv.frag";
}

void PhongEnvMaterial::applyUniforms(
	Shader* shader,
	Mesh* mesh,
	Camera* camera,
