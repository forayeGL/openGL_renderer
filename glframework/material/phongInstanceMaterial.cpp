...
const char* PhongInstanceMaterial::getVertexShaderPath() const {
	return "assets/shaders/phongInstance.vert";
}

const char* PhongInstanceMaterial::getFragmentShaderPath() const {
	return "assets/shaders/phongInstance.frag";
}

void PhongInstanceMaterial::applyUniforms(
	Shader* shader,
	Mesh* mesh,
	Camera* camera,
